...
export default async function deployApi(referencesPromise, {bundleSource, pathResolve}) {
    ...
    const INSTANCE_REG_KEY = await E(registry).register(`${installationConstants.CONTRACT_NAME}instance`, instanceHandle);

    console.log(`-- Contract Name: ${installationConstants.CONTRACT_NAME}`);
